...
scope: backend, architecture, code-review
version: 1.0
priority: critical
assumptions:
  - This code runs in production
  - Business logic correctness is more important than developer convenience
  - Refactoring must consider operational risk
---
